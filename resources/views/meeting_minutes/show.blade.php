    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div class="d-flex justify-content-between">
                <div>
                    <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">HR Manual / <a href="{{ route('meeting-minutes.index') }}">Meeting minute</a> / </span>{{ $meetingMinute->title }}</h5>
                </div>
                <div>
