        ...
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div>
                @if (session()->has('message'))
                    <div class="alert alert-success alert-dismissible text-white" role="alert" style="padding: 10px;background-color: rgb(116, 203, 128);color: white;margin-bottom: 15px;">
    ...
    <div class="row mb-2">
        <div class="col-lg-12 col-md-12 col-12">
            <div class="d-flex justify-content-between">
                <div class="d-flex">
                    <h5 class="fw-bold text-capitalize"><span class="text-muted fw-light">Loan service / <a href="{{ route('loan-approval.index') }}">List of loan approvals</a> / </span>{{ $loanApplication->ref_code }}</h5>
                    <div class="ps-3">
                ...
                @if(!$loanApplication->is_approved)
                    <div>
