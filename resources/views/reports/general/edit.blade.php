    ...
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Reports / <a href="{{ route('general-reports.index') }}">List of general reports</a> / </span>{{ $generalReport->title }}</h5>
                <div>
            ...
            <div class="card p-3">
                <div class="card-body">
                    <form method="POST" action="{{ route('general-reports.update', $generalReport) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label text-secondary camel-sent fs-6" for="amount">Attach report</label>
                            <div class="col-sm-9">
