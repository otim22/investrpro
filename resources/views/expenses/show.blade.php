    ...
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h4 class="fw-bold text-capitalize"><span class="text-muted fw-light">Expense / <a href="{{ route('expenses.index') }}">All expenses</a> / </span>{{ $expense->formatDate($expense->date_of_expense) }}</h4>
            </div>
        </div>
    </div>
    <div class="row mb-4">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a class="btn btn-sm btn-outline-primary text-capitalize" type="button"
                        href="{{ route('expenses.index') }}" aria-haspopup="true" aria-expanded="false">
