...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Liability settings / <a href="{{ route('liability-settings.index') }}">List of liability settings</a> / </span>liability form</h5>
                <div>
    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card p-3">
                <div class="card-body">
                    <form method="POST" action="{{ route('liability-settings.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10 mt-2">
                                <button type="submit" class="btn btn-primary text-capitalize">Create setting</button>
                            </div>
                        </div>
                    </form>
                </div>
