    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div class="d-flex justify-content-between">
                <div>
                    <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Asset settings / <a href="{{ route('asset-settings.index') }}">List of asset settings</a> / </span>{{ $assetSetting->asset_type }}</h5>
                </div>
                <div>
