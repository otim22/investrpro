            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="d-flex justify-content-between pb-2">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-sm btn-outline-primary" type="button" aria-haspopup="true" aria-expanded="false">
                            Create
                        </button>
                    </div>
                </div>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table table-striped table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td> Otim Fredrick</td>
                        <td><i class="fab fa-vuejs fa-lg text-success"></i> <strong>VueJs Project</strong></td>
                        <td>Trevor Baker</td>
                        <td>
                          Otim
                        </td>
                      ...
                      <tr>
                        <td> Otim Fredrick</td>
                        <td>
                          <i class="fab fa-bootstrap fa-lg text-primary"></i> <strong>Bootstrap Project</strong>
                        </td>
                        <td>Jerry Milton</td>
                        <td>
                          Otim
