    ...
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Profit & Loss / <a href="{{ route('liabilities.index') }}">Liabilities</a> / </span>Liability form</h5>
                <div>
                    ...
                    <form method="POST" action="{{ route('liabilities.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10 mt-2">
                                <button type="submit" class="btn btn-primary text-capitalize">Save liability</button>
                            </div>
                        </div>
                    </form>
                </div>
