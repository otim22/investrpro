      ...
      <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Investments / </span>List of ({{ count($investments) }}) investments</h5>
                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-nowrap text-capitalize"> 
                                                ...
                                                <span>Amount:</span> 
                                                <span class="text-muted">UGX {{ number_format($investment->amount_invested) }}/-</span>
                                            </span> <br />
                                            <span class="text-nowrap text-capitalize"> 
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"/>
                                                ...
                                                <span class="text-muted">{{ $investment->interest_rate }} </span>
                                            </span> <br />
                                            <span class="text-nowrap text-capitalize"> 
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"/>
                                                ...
                                                <span>End:</span> 
                                                <span class="text-muted">{{ $investment->formatDate($investment->date_of_maturity) }} </span>
                                            </span>
                                        </td>
                                        <td>
                                            <span class="text-nowrap text-capitalize"> 
                                                ...
                                                <span class="text-muted">{{ $investment->expected_return_before_tax }} 
                                            </span> <br />
                                            <span class="text-nowrap text-capitalize"> 
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"/>
                                                ...
                                                <span>After tax:</span> 
                                                <span class="text-muted">{{ $investment->expected_return_after_tax }}
                                            </span>
                                        </td>
                                        <td>
                                            @if($investment->interest_recieved_and_reinvested)
                                                ...
                                                <span class="text-nowrap text-capitalize"> <span>Amount:</span> <span class="text-muted">UGX {{ number_format($investment->interest_recieved_and_reinvested) }}/-</span></span>
                                            @else
                                                --
                                            @endif
                                        </td>
