...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div class="d-flex justify-content-between">
                <div>
                    <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">General / <a href="{{ route('financial-years.index') }}">Financial year</a> / </span>{{ $financialYear->title }}</h5>
                </div>
                <div>
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item btn-sm" href="{{ route('financial-years.edit', $financialYear) }}">
            ...
            <form action="{{ route('financial-years.destroy', $financialYear) }}" class="hidden" id="delete-year-{{ $financialYear->id }}"
                method="POST">
                @csrf
                @method('delete')
            </form>
    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card p-3">
                <div class="card-body">
                    <form method="POST" action="{{ route('financial-years.update', $financialYear) }}" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
