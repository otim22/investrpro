    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
                <h4 class="fw-bold py-1"><span class="text-muted text-capitalize fw-light">Members / <a href="{{ route('members.show', $member) }}">{{ $member->surname }} {{ $member->given_name }} </a> / </span>Kin</h4>
            </div>
        </div>
        <div class="row mb-4">
