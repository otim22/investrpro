    ...
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h4 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Investments / <a href="{{ route('investments.index') }}">List of investments</a> / </span>investment form</h4>
                <div>
