    ...
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h5 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Fund / <a href="{{ route('late-remissions.index') }}">List of late remissions</a> / </span>{{ $lateRemission->member->surname }} {{ $lateRemission->member->given_name }}</h5>
                <div>
