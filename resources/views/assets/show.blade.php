    ...
    <div class="row">
        <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
            <div class="d-flex justify-content-between">
                <h4 class="fw-bold py-1 text-capitalize"><span class="text-muted fw-light">Assets / <a href="{{ route('assets.index') }}">List of assets</a> / </span>{{ $asset->asset_name }}</h4>
            </div>
        </div>
    </div>
    <div class="row mb-4">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a class="btn btn-sm btn-outline-primary text-capitalize" type="button"
                        href="{{ route('assets.index') }}" aria-haspopup="true" aria-expanded="false">
