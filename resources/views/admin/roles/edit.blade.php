        ...
        <div class="row mb-2">
            <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2">
                <div class="d-flex justify-content-between">
                    <h5 class="fw-bold">
                        <span class="text-muted text-capitalize fw-light">Roles / <a href="{{ route('admin.roles.index') }}">List of roles</a> / </span>{{ $role->name }}
                    </h5>
                    <div>
                ...
                <div class="card p-3">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.roles.update', $role) }}">
                            ...
                            <div class="row">
                                <label class="col-sm-2 col-form-label text-secondary camel-sent fs-6" for="permissions">Assign Permissions</label>
                                <div class="col-sm-10">
